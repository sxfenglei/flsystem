...
<form action="<?php echo U('AuthGroup/authGroupAdd');?>" method="post">
<!-- Input -->
<div class="box box-info">
  ...
  <div class="box-body">
    <div class="row">
      <div class="col-md-6">
          <input type="text" name="title" required="required" title="角色名称不可为空" class="form-control" placeholder="请填写角色名称">
      </div>
      <div class="col-md-4">
        应用管理员角色名称
      </div>
      ...
      <div class="col-md-6 quanxian">
          <table class="table table-bordered"> 
              <?php if(is_array($authRuleList)): $i = 0; $__LIST__ = $authRuleList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                <td>
                  <?php echo ($vo["html"]); ?>
                  <input type="checkbox" name="" value="<?php echo ($vo["id"]); ?>" data-str="<?php echo ($vo["title"]); ?>">
                  <?php echo ($vo["title"]); ?>
                </td>
    ...
    <input type="hidden" name="authRuleIds" id="authRuleIds" value="">
    <input type="hidden" name="authRuleStr" id="authRuleStr" value="">
