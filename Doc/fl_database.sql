...
MySQL - 5.5.47 : Database - fl_database
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`fl_database` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `fl_auth_rule`(`id`,`parent_id`,`name`,`title`,`type`,`status`,`condition`) values (1,0,'/Admin/','主模块',1,1,''),(2,1,'/Admin/Index/','默认控制器',1,1,''),(3,2,'/Admin/Index/index/','主页面',1,1,''),(4,1,'/Admin/Setting/','系统配置',1,1,''),(7,4,'/Admin/Setting/info/','基本信息设置',1,1,''),(8,4,'/Admin/Setting/wx/','微信设置',1,1,''),(9,4,'/Admin/Setting/email/','邮件设置',1,1,''),(10,1,'/Admin/Shop/','店铺管理',1,1,''),(11,10,'/Admin/Shop/index/','店铺列表',1,1,''),(12,10,'/Admin/Shop/add/','创建店铺',1,1,''),(13,10,'/Admin/Shop/edit/','编辑店铺',1,1,''),(14,10,'/Admin/Shop/del/','删除店铺',1,1,''),(15,10,'/Admin/Shop/virtualDel/','虚拟删除店铺',1,1,''),(16,1,'/Admin/Admin/','应用管理员员工管理',1,1,''),(17,16,'/Admin/Admin/index/','员工列表',1,1,''),(18,16,'/Admin/Admin/add/','添加员工',1,1,''),(19,16,'/Admin/Admin/edit/','编辑员工',1,1,''),(20,16,'/Admin/Admin/virtualDel/','虚拟删除员工',1,1,''),(21,16,'/Admin/Admin/del/','删除员工',1,1,''),(22,4,'/Admin/Setting/index/','基本设置',1,1,'');
